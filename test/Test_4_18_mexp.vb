...
Public Class Test_4_18_MExp
    ...
    Public Sub Run()
        Dim name As String = "test_4_18_mexp"
    ...
    Public Function GetDataTable() As DataTable
        ...
        ret.Columns.Add("op", GetType(String))
        ret.Columns.Add("v1", GetType(Decimal))
        ret.Columns.Add("v2", GetType(Decimal))
        ret.Rows.Add("add", 20, 15)
        ret.Rows.Add("sub", 20, 15)
        ret.Rows.Add("mul", 20, 15)
        Return ret
    End Function
